	...
	>
				...
				<div class="flex gap-2">
					...
					{#if rows.length > 1}
						<button
							...
							class="rounded-xl border border-stone-200 px-2.5 py-2 text-neutral-400 hover:text-neutral-700 focus-visible:ring-1 focus-visible:ring-stone-400 focus-visible:outline-none"
							aria-label="Remove"
						>
							<svg
								xmlns="http://www.w3.org/2000/svg"
		...
		<div class="mt-5 flex items-center justify-between">
			<button
				type="button"
				on:click={addRow}
				class="rounded text-sm text-neutral-500 hover:text-neutral-800 focus-visible:ring-1 focus-visible:ring-stone-400 focus-visible:outline-none"
			>
				+ Add another
			</button>
			<div class="flex gap-2">
