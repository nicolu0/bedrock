...
<div class="space-y-6">
	<div class="flex items-center justify-between">
		...
		<div class="flex items-center gap-2">
			...
			>
				...
				>
					<path
						d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm2-3a2 2 0 1 1-4 0 2 2 0 0 1 4 0zm4 8c0 1-1 1-1 1H1s-1 0-1-1 1-4 6-4 6 3 6 4zm-1-.004c-.001-.246-.154-.986-.832-1.664C9.516 10.68 8.289 10 6 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664h9.996z"
					/>
					<path
						fill-rule="evenodd"
	...
	<div class="flex items-stretch gap-3">
		<div class="flex w-80 items-center gap-2 rounded-lg border border-neutral-200 bg-white px-3">
			<svg
				xmlns="http://www.w3.org/2000/svg"
				width="14"
				height="14"
		...
		<button class="rounded-lg border border-neutral-200 bg-white px-3 text-sm text-neutral-700">
			All
		</button>
	</div>
		...
		{#if members !== null}
			{#each members as member}
				<div class="grid grid-cols-[2fr_1fr] gap-4 border-t border-neutral-100 px-5 py-3 text-sm">
					...
					<div>
						<span
							class="rounded-full bg-stone-100 px-2.5 py-0.5 text-xs font-medium text-neutral-600"
						>
